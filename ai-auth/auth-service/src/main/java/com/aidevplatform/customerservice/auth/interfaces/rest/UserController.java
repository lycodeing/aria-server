...
import com.aidevplatform.customerservice.auth.application.service.UserApplicationService;
import com.aidevplatform.customerservice.auth.domain.model.user.User;
import com.aidevplatform.customerservice.auth.interfaces.assembler.UserAssembler;
...
public class UserController {
    ...
    public R<GpgKeyVO> addGpgKey(@RequestBody AddGpgKeyRequest req) {
        ...
        return R.ok(new GpgKeyVO(
                com.aidevplatform.common.core.util.IdGenerator.nextId(),
                "ABCD1234",
