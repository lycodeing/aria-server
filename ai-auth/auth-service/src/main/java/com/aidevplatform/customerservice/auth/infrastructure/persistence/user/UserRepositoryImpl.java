package com.aidevplatform.customerservice.auth.infrastructure.persistence.user;

import com.aidevplatform.customerservice.auth.domain.model.user.*;
import com.aidevplatform.customerservice.auth.domain.repository.IUserRepository;
import com.aidevplatform.customerservice.auth.infrastructure.persistence.role.PermissionMapper;
import com.aidevplatform.customerservice.auth.infrastructure.persistence.role.RoleDO;
import com.aidevplatform.customerservice.auth.infrastructure.persistence.role.RoleMapper;
import com.aidevplatform.customerservice.auth.application.query.UserPageQuery;
...
public class UserRepositoryImpl implements IUserRepository {
    ...
    public User save(User user) {
        UserDO existing = user.getId() != null ? mapper.selectById(user.getId().getValue()) : null;
        UserDO DO = toDO(user);
        if (existing == null) {
            mapper.insert(DO);
        } else {
