...
import com.aidevplatform.common.core.domain.AggregateRoot;
import com.aidevplatform.common.core.exception.BusinessException;
import com.aidevplatform.customerservice.auth.domain.event.UserDisabled;
import com.aidevplatform.customerservice.auth.domain.event.UserLoginFailed;
import com.aidevplatform.customerservice.auth.domain.event.UserLoginSucceeded;
import com.aidevplatform.customerservice.auth.domain.event.UserPasswordChanged;
import com.aidevplatform.customerservice.auth.domain.event.UserRegistered;
import com.aidevplatform.customerservice.auth.domain.event.UserRoleChanged;
