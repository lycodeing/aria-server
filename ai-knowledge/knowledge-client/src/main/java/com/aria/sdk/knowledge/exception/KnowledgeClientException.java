package com.aria.sdk.knowledge.exception;

import com.aria.common.sdk.exception.SdkException;

/**
 * knowledge-client 业务异常。
 *
 * <p>封装两种失败：
 * <ul>
 ...
 * @since 2026-07
 */
public class KnowledgeClientException extends SdkException {
    ...
    public KnowledgeClientException(String message) {
        this(message, UNKNOWN_CODE, UNKNOWN_CODE, null);
    }

    public KnowledgeClientException(String message, Throwable cause) {
        this(message, UNKNOWN_CODE, UNKNOWN_CODE, cause);
    }

    public KnowledgeClientException(String message, int httpStatus, int bizCode, Throwable cause) {
        super(message, cause);
