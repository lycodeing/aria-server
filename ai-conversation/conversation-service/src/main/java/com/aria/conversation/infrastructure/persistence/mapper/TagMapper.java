 ...
 * 标签 Mapper。
 *
 * <p>单表查询通过 LambdaWrapper 完成；usage_count 使用 setSql 保证数据库侧原子性，
 * 避免先读后写的竞态条件。
 */
@Mapper
public interface TagMapper extends BaseMapper<TagEntity> {
     ...
     * @param id 标签 ID
     */
    default void atomicIncrUsageCount(Long id) {
        update(null, Wrappers.<TagEntity>lambdaUpdate()
     ...
     * @param id 标签 ID
     */
    default void atomicDecrUsageCount(Long id) {
        update(null, Wrappers.<TagEntity>lambdaUpdate()
