...
/**
 * 处理 {@link RouteResult.PendingResult}：追加助手历史，
 * 返回 {@link ChatEvent#candidates(String)} 或 {@link ChatEvent#slotAsk(String)}。
 */
@Slf4j
@Component
...
public class PendingRouteHandler implements RouteResultHandler {
    ...
    public boolean supports(RouteResult route) {
        return route instanceof RouteResult.PendingResult;
    }
