...
class SessionQueueServiceGetAgentIdTest {
    ...
    void setUp() throws Exception {
        ...
        // 构造器参数顺序：queueRepository, agentRegistry, publisher, rabbitTemplate, eventsExchange, persistRepository, csatService, visitorNotifier, configProvider, redissonClient
        service = new SessionQueueService(
                queueRepository, null, null, null, null, null, null, null, null, null);
    }
